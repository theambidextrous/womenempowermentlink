            ...
            <div class="card-body">
                <h5 class="card-title">My Timeline
                    <span class="pull-right"> 
                        <button type="button" class="btn mr-2 mb-2 btn-primary fundsmodal" data-toggle="modal" data-target="#forummodal"> <i class="pe-7s-plus text-white"></i> Ask in Forum </button>
                    </span>
                </h5>
                <br>
                <!-- messges -->
                ...
                <div class="card-body forum-box">
                    ...
                    <div class="app-inner-layout__bottom-pane d-block text-center">
                        <div class="mb-0 position-relative row form-group">
                            <form class="form-inline form-reply" action="{{route('s_add_freply')}}" method="POST">
                                @csrf
                                <div class="col-sm-8">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('s_add_forum')}}" method="POST" id="newcourse" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12">
