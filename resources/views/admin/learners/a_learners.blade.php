                    ...
                    <table class="mb-0 table table-sm">
                        <thead>
                            <tr>
                                ...
                                <th><small>Date Enrolled</small></th>
                        ...
                        <tbody>
                            @if(count($learners))
                                ...
                                <tr>
                                    <td><a href="{{route('a_learnerhome',['id' => $_learner['id']])}}" class="mb-2 mr-2 btn-transition btn btn-link-primary">{{$_learner['name']}}</a></td>
                                    <td>{{$_learner['email']}}</td>
                                    <td>{{$_learner['phone']}}</td>
                                    <td>{{date('M jS, 2020', strtotime($_learner['updated_at']))}}</td>
                                    <td><a href="{{route('a_learnerhome',['id' => $_learner['id']])}}" class="mb-2 mr-2 btn-transition btn btn-outline-primary">More info</a>
                                    </td>
                                </tr>
                                @endforeach
                            @endif
