                        ...
                        <tbody>
                            @if(count($admins))
                                ...
                                <tr>
                                    ...
                                    <td>{{$_admin['email']}}</td>
                                    <td>{{$_admin['phone']}}</td>
                                    <td>{{date('M jS, 2020', strtotime($_admin['updated_at']))}}</td>
                                </tr>
                                @endforeach
                            @endif
                        </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-white" id="exampleModalLabel">Create New Administrator</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('a_add_admin')}}" method="POST" id="newcourse">
                    @csrf
                    <div class="form-row">
                        <div class="col-md-12">
                    ...
                    <button type="submit" class="mt-2 btn btn-primary">Add Administrator </button>
                </form>
            </div>
